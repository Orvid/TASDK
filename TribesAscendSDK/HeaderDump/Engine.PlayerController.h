...
namespace UnrealScript
{
	...
	{
	public:
		typedef PlayerController__EProgressMessageType EProgressMessageType;
		typedef PlayerController__EInputMatchAction EInputMatchAction;
		typedef PlayerController__EInputTypes EInputTypes;
		typedef PlayerController__DebugTextInfo DebugTextInfo;
		typedef PlayerController__ConnectedPeerInfo ConnectedPeerInfo;
		typedef PlayerController__ClientAdjustment ClientAdjustment;
		typedef PlayerController__InputMatchRequest InputMatchRequest;
		typedef PlayerController__InputEntry InputEntry;
