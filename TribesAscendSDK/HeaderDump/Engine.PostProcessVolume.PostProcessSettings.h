...
namespace UnrealScript
{
	...
	{
	public:
		ADD_STRUCT(PostProcessVolume__LUTBlender, ColorGradingLUT, 196)
		ADD_OBJECT(Texture, ColorGrading_LookupTable, 192)
		ADD_STRUCT(float, RimShader_InterpolationDuration, 188)
		ADD_STRUCT(Object__LinearColor, RimShader_Color, 172)
		...
		ADD_STRUCT(DOFEffect__EFocusType, DOF_FocusType, 56)
		ADD_STRUCT(Object__Color, DOF_ModulateBlurColor, 52)
		...
		ADD_STRUCT(Object__Color, Bloom_Tint, 16)
