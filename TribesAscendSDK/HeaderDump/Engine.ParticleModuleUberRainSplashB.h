...
namespace UnrealScript
{
	...
	{
	public:
		ADD_STRUCT(DistributionFloat__RawDistributionFloat, StartRotationRate, 228)
		ADD_BOOL(MultiplyZ, 224, 0x4)
		ADD_BOOL(MultiplyY, 224, 0x2)
		ADD_BOOL(MultiplyX, 224, 0x1)
		ADD_STRUCT(DistributionVector__RawDistributionVector, LifeMultiplier, 196)
		ADD_STRUCT(DistributionFloat__RawDistributionFloat, AlphaOverLife, 168)
		ADD_STRUCT(DistributionVector__RawDistributionVector, ColorOverLife, 140)
