...
namespace UnrealScript
{
	...
	{
	public:
		typedef TrPawn__PhysicsType PhysicsType;
		typedef TrPawn__WalkingDeceleration WalkingDeceleration;
		typedef TrPawn__AssistInfo AssistInfo;
		typedef TrPawn__FootstepParticleInfo FootstepParticleInfo;
		typedef TrPawn__StickyGrenadeSocketInfo StickyGrenadeSocketInfo;
