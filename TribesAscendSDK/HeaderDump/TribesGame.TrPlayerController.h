...
namespace UnrealScript
{
	...
	{
	public:
		typedef TrPlayerController__TrCameraShakeInfo TrCameraShakeInfo;
		typedef TrPlayerController__VGSAudioCommand VGSAudioCommand;
		typedef TrPlayerController__SpectatorKeybindViewTargetMap SpectatorKeybindViewTargetMap;
		typedef TrPlayerController__PendingSkin PendingSkin;
