...
namespace UnrealScript
{
	...
	public:
		...
		void Set(ScriptString* Member, GFxMoviePlayer__ASValue Arg)
		{
		...
		GFxObject__ASDisplayInfo GetDisplayInfo()
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(30040);
			byte params[44] = { NULL };
			((ScriptObject*)this)->ProcessEvent(function, &params, NULL);
			return *(GFxObject__ASDisplayInfo*)params;
		}
		...
		GFxObject__ASColorTransform GetColorTransform()
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(30046);
			byte params[32] = { NULL };
			((ScriptObject*)this)->ProcessEvent(function, &params, NULL);
			return *(GFxObject__ASColorTransform*)params;
		}
		Object__Matrix GetDisplayMatrix()
		{
		...
		void SetDisplayInfo(GFxObject__ASDisplayInfo D)
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(30050);
			byte params[44] = { NULL };
			*(GFxObject__ASDisplayInfo*)params = D;
			((ScriptObject*)this)->ProcessEvent(function, &params, NULL);
		}
		...
		void SetColorTransform(GFxObject__ASColorTransform cxform)
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(30055);
			byte params[32] = { NULL };
			*(GFxObject__ASColorTransform*)params = cxform;
			((ScriptObject*)this)->ProcessEvent(function, &params, NULL);
		}
		void SetDisplayMatrix(Object__Matrix M)
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(30057);
			byte params[64] = { NULL };
			*(Object__Matrix*)params = M;
			((ScriptObject*)this)->ProcessEvent(function, &params, NULL);
		}
		void SetDisplayMatrix3D(Object__Matrix M)
		{
		...
		GFxMoviePlayer__ASValue GetElement(int Index)
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(30068);
			byte params[28] = { NULL };
			*(int*)params = Index;
			((ScriptObject*)this)->ProcessEvent(function, &params, NULL);
			return *(GFxMoviePlayer__ASValue*)&params[4];
		}
		...
		void SetElement(int Index, GFxMoviePlayer__ASValue Arg)
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(30084);
			byte params[28] = { NULL };
			*(int*)params = Index;
			*(GFxMoviePlayer__ASValue*)&params[4] = Arg;
			((ScriptObject*)this)->ProcessEvent(function, &params, NULL);
		}
		...
		GFxObject__ASDisplayInfo GetElementDisplayInfo(int Index)
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(30099);
			byte params[48] = { NULL };
			*(int*)params = Index;
			((ScriptObject*)this)->ProcessEvent(function, &params, NULL);
			return *(GFxObject__ASDisplayInfo*)&params[4];
		}
		Object__Matrix GetElementDisplayMatrix(int Index)
		{
		...
		void SetElementDisplayInfo(int Index, GFxObject__ASDisplayInfo D)
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(30105);
			byte params[48] = { NULL };
			*(int*)params = Index;
			*(GFxObject__ASDisplayInfo*)&params[4] = D;
			((ScriptObject*)this)->ProcessEvent(function, &params, NULL);
		}
		void SetElementDisplayMatrix(int Index, Object__Matrix M)
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(30108);
			byte params[68] = { NULL };
			*(int*)params = Index;
			*(Object__Matrix*)&params[16] = M;
			((ScriptObject*)this)->ProcessEvent(function, &params, NULL);
		}
		...
		void SetElementColorTransform(int Index, GFxObject__ASColorTransform cxform)
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(30118);
			byte params[36] = { NULL };
			*(int*)params = Index;
			*(GFxObject__ASColorTransform*)&params[4] = cxform;
			((ScriptObject*)this)->ProcessEvent(function, &params, NULL);
		}
		GFxMoviePlayer__ASValue GetElementMember(int Index, ScriptString* Member)
		{
			...
			*(ScriptString**)&params[4] = Member;
			((ScriptObject*)this)->ProcessEvent(function, &params, NULL);
			return *(GFxMoviePlayer__ASValue*)&params[16];
		}
		...
		void SetElementMember(int Index, ScriptString* Member, GFxMoviePlayer__ASValue Arg)
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(30142);
			byte params[40] = { NULL };
			*(int*)params = Index;
			*(ScriptString**)&params[4] = Member;
			*(GFxMoviePlayer__ASValue*)&params[16] = Arg;
			((ScriptObject*)this)->ProcessEvent(function, &params, NULL);
		}
		...
		GFxMoviePlayer__ASValue Invoke(ScriptString* Member, ScriptArray<GFxMoviePlayer__ASValue> args)
		{
