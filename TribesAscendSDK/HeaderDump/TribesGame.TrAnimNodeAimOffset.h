...
namespace UnrealScript
{
	...
	{
	public:
		ADD_STRUCT(Object__Vector2D, m_TargetRandomAimLocation, 388)
		...
		ADD_STRUCT(Object__Vector2D, m_RandomAimPointsRangeY, 364)
		ADD_STRUCT(Object__Vector2D, m_RandomAimPointsRangeX, 356)
		...
		ADD_STRUCT(Object__Vector2D, m_v2dLastPostProcessedAimOffset, 336)
		ADD_STRUCT(Object__Vector2D, m_v2dLastAimOffset, 328)
