...
namespace UnrealScript
{
	...
	{
	public:
		ADD_STRUCT(DistributionFloat__RawDistributionFloat, AlphaOverLife, 344)
		ADD_STRUCT(DistributionVector__RawDistributionVector, ColorOverLife, 316)
		ADD_STRUCT(ParticleModuleLocationPrimitiveCylinder__CylinderHeightAxis, PC_HeightAxis, 312)
		ADD_STRUCT(DistributionFloat__RawDistributionFloat, PC_StartHeight, 284)
		ADD_STRUCT(DistributionFloat__RawDistributionFloat, PC_StartRadius, 256)
		ADD_STRUCT(DistributionVector__RawDistributionVector, PC_StartLocation, 228)
		ADD_STRUCT(DistributionFloat__RawDistributionFloat, PC_VelocityScale, 200)
